                ...
                <div class="card-body">
                    <form action="<?= route_to('admin/menu') ?>" method="post" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select multiple="multiple" class="form-control " name="groups_menu[]" data-placeholder="<?= lang('boilerplate.role.fields.plc_name') ?>" style="width: 100%;">
                        ...
                        <div class="form-group row">
                            <div class="offset-sm-2 col-sm-10">
                                <button type="submit" class="float-left btn btn-sm btn-primary"><?= lang('boilerplate.global.save') ?></button>
                            </div>
                        </div>
                    </form>
                </div>
